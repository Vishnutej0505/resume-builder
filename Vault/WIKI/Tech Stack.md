...
- **Local UI verification uses `expo start --web`** via `.claude/launch.json`, previewed in the Browser pane at mobile viewport size — confirms real rendering and interaction (typing, modals, AI error states) without needing a device or emulator.
